...
**Research quesion 1:**
If you slept less than 8 hours per day, what is the probability that you got a goofd mental health?
<ul>
...
<li>Leisure Time Physical Activity Calculated Variable (_TOTINDA)</li>
</ul>
**Research quesion 3:**
 If we know someone is not eating fruit, what is the probability he/she has health condition poor?<br>Base on following collections of data:
<ul>
...
<li>How’s the relation between general health (genhlth) and eating no fruit/vegi every day (fruit < 1)?</li>
</ul>
